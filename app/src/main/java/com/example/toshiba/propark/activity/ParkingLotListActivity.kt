...
class ParkingLotListActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference!!.collection("Parking Lot").get().addOnSuccessListener {
            ...
            val areasAdapter =
                ArrayAdapter(this@ParkingLotListActivity, android.R.layout.simple_spinner_item, areas)
        ...
        button2.setOnClickListener {
            val button2Intent = Intent(this@ParkingLotListActivity, AdminParkingActivity::class.java)
